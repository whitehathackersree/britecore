angular.
module('control')
.controller('dmbsControlController', ['$sce', '$route', '$routeParams', '$scope', '$location',
...
.constant('dmbsControlConfig', {
  srcErrorMessage: 'Couldn\'t load this tab!',
})
.directive('dmbsControl', ['$parse', '$http', '$compile', 'SETTINGS', 'dmbsControlConfig',
 function($parse, $http, $compile, SETTINGS, dmbsControlConfig){
  return {
    restrict: 'EA',
    transclude: true,
    scope: {
    ...
    controller: 'dmbsControlController',
    templateUrl: '/static/js/app/control/dmbs-control/dmbs-control.template.html?v='+SETTINGS.VERSION,
    replace: true,
    link: function(scope, element, attrs, dmbsControlCtrl){
