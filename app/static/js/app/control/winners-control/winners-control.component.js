...
.controller('winnersControlController', ['$sce', '$route', '$routeParams', '$scope', '$location',
 '$timeout', '$q', '$element', 'Spinner', 'Aurora', 'AuroraModal', 'WinnerData',
 function($sce, $route, $routeParams, $scope, $location, $timeout,$q, $element, Spinner, Aurora, AuroraModal, WinnerData){
  var self = this;
  ...
  $scope.editWinnerDelivery = function(wd){
    AuroraModal.type="control-edit-winner-delivery";
    AuroraModal.data={
      id: wd.id
    }
